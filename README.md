...
[![CI](https://github.com/danikoptimus-hash/abset/actions/workflows/ci.yml/badge.svg)](https://github.com/danikoptimus-hash/abset/actions/workflows/ci.yml)

`[Screenshot: реестр экспериментов ABSet]`
...
- **[docs/PRESENTATION.md](docs/PRESENTATION.md)** — для руководства: зачем
  ABSet нужен компании, в 10 слайдах.
...
```bash
git clone https://github.com/danikoptimus-hash/abset.git && cd abset
